...
1. This copy of the NRC Sentiment140 Lexicons is to be used for research purposes only.  Please contact NRC if interested in a commercial license.

2. Do not redistribute the NRC Sentiment140 Lexicons. Please refer interested parties to Saif Mohammad (saif.mohammad@nrc-cnrc.gc.ca).

3. When publishing results of research that used NRC Sentiment140 Lexicons, please acknowledge their use and cite the following publication:
...
The NRC Sentiment140 Lexicons are automatically generated from the following data source:
