...
# The baseline classifier for SA

class BaseLine(object):
	def __init__(self, feature_union=None, classifier=None, training_set, test_set):
		self.clf = get_classifier(classifier)
	...
	def get_classifier(self, argument):
		return {
			"linearsvm": LinearSVC(),
			"svm": SVC(),
			"maxent": LogisticRegression(),
			"nb": MultinomialNB()
		}.get(argument, LinearSVC())
